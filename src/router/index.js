...
export const constantRoutes = [
  ...
  //     {
  //       path: 'company',
  //       component: () => import('@/views/manage/company'),
  //       name: 'manageCompany',
  //       meta: {title: '企业管理', icon: 'side-build'}
  //     }, {
  //       path: 'tag',
  //       component: () => import('@/views/manage/tag'),
  //       name: 'manageTag',
  //       meta: {title: '标签管理', icon: 'side-tag'}
  //     },
  //   ]
  // },
    ...
    children: [
      {
        ...
        name: 'manageData',
        meta: {title: '数据模型管理', icon: 'side-data'}
      },
    ]
  },
  {
    ...
    children: [
      {
        ...
        name: 'manageUser',
        meta: {title: '用户管理', icon: 'side-user'}
      },
    ]
  },
  {
    ...
    children: [
      {
        ...
        name: 'manageCount',
        meta: {title: '数据统计', icon: 'side-count'}
      },
    ]
  },
  {
    ...
    children: [
      {
        ...
        name: 'manageManager',
        meta: {title: '运营人员管理', icon: 'side-manage'}
      },
    ]
  },
  {
